public class Main {
    ...
    static String bothEnds(String s)
    {
        ...
        {
            String elso = s.substring(0,2);
            String hatso = s.substring(s.length()-2);
            return elso + hatso;
        }
    }
    ...
    {
        String stra = a.substring(0,2);
        String strb = b.substring(0,2);
        String marada = a.substring(2);
        String maradb = b.substring(2);
        return strb+marada + " " + stra + maradb;
    }
